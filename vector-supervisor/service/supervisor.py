...
logging.debug("Supervisor started")
...
# Inizio file: definisci una variabile globale
last_robot_state_save = 0
...
def save_observed_object(robot, event_type, event):
    ...
    # Salva solo se sono passati almeno 2 secondi
    if now_timestamp - last_robot_state_save < 2:
        return

    last_robot_state_save = now_timestamp
